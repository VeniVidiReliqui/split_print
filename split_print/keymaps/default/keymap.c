...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KEYMAP(
		...
		KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,        KC_N,    KC_M,    KC_COMM,  KC_DOT,  KC_SLSH, KC_RSFT, \
		KC_LCTL, KC_M,    KC_I,    KC_F1,   KC_SPC,  KC_LALT,     KC_SPC,  KC_UP,   KC_DOWN,  KC_LEFT, KC_RGHT, TG(1) \
        ),

    // Pok3r inspired function layer
	KEYMAP(
		KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,       KC_F6,   KC_F7,   KC_F8,    KC_F9,   KC_F10,  KC_DEL, \
		KC_TAB,  KC_MPRV, KC_MPLY, KC_MNXT, KC_NO,   KC_NO,       S(KC_3), KC_PGDN, KC_UP,    KC_PGUP, KC_MINS, KC_NO, \
	...
	KEYMAP(
		...
		KC_NO,   KC_ACL2, KC_BTN4, KC_BTN3, KC_BTN5, KC_NO,       KC_NO,   KC_7,    KC_8,     KC_9,    KC_PSLS, KC_BSLS, \
		...
		KC_SLEP, MO(3),   TG(1),   KC_LALT, KC_LGUI, KC_BTN1,     KC_NO,   MO(3),   KC_0,     KC_PDOT, KC_PPLS, TG(3) \
        )
};
