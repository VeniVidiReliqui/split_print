...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KEYMAP(
		...
		KC_LCTL, TG(3),   KC_NO,   KC_LALT, KC_RGUI, KC_SPC,       KC_SPC,  KC_BSPC, KC_LBRC,  KC_RBRC, KC_GRV,  TG(2) \
        ),
	...
	KEYMAP(
		...
		KC_NO,   TG(3),   KC_NO,   KC_NO,   KC_NO,   KC_NO,        KC_RBRC, KC_0,    KC_0,     KC_DOT,  KC_PENT, KC_NO \
        )
