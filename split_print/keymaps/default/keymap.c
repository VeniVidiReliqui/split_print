...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KEYMAP(
		KC_PWR,  KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,       KC_ESC,  KC_TAB,  KC_SLSH,  KC_ASTR, KC_DEL,  KC_BSPC, \
		KC_NO,   KC_ACL2, KC_NO,   KC_BTN3, KC_NO,   KC_NO,       KC_LPRN, KC_7,    KC_8,     KC_9,    KC_MINS, KC_BSLS, \
		KC_NO,   KC_ACL1, KC_BTN1, KC_MS_U, KC_BTN2, KC_WH_D,     KC_RPRN, KC_4,    KC_5,     KC_6,    KC_PLUS, KC_ENT, \
		KC_NO,   KC_ACL0, KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_U,     KC_LBRC, KC_1,    KC_2,     KC_3,    KC_EQL,  KC_RSFT, \
		KC_SLEP, MO(3),   TG(2),   KC_BTN4, KC_BTN5, KC_BTN1,     KC_RBRC, KC_0,    KC_0,     KC_DOT,  KC_PENT, TG(3) \
        )
